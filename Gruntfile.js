module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        myth: {
            dist: {
                files: {
                    ...
                    'css/themes/stratis.css': 'css/sources/themes/stratis.css',
                }
            }
        },
        ...
        cmq: {
            dist: {
                files: {
                    ...
                    'css/themes/stratis.css': 'css/themes/stratis.css',
                }
            },
        },
        ...
        cssmin: {
            ...
            stratis: {
                files: {'css/themes/stratis.min.css': 'css/themes/stratis.css'}
            },
